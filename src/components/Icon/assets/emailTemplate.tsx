...
const EmailStrokeSD = ({ className }: IconInputProps) => {
  return (
    <svg
      className={` ${className ?? ''}`}
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M10.5498 9.23H13.8798" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9.72021 6.23H14.7202" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};

export default EmailStrokeSD;
