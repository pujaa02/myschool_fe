...
export const useLanguage = (state: RootState) => state.language;
export const useDefaultLanguage = (state: RootState) =>
  state.language.defaultLanguage;

export const { setLanguage, setAllLanguage, setDefaultLanguage } =
  slice.actions;
